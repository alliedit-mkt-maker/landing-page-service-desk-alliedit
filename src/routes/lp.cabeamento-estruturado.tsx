...
const title = "Empresa de cabeamento estruturado com laudo | Allied IT";
const description =
...
export const cabeamentoEstruturadoMeta = { title, description };

export function CabeamentoEstruturadoPage() {
  return (
    <LpProvider modalTitle="Vamos falar do seu projeto de cabeamento estruturado." formId="55119813-69a4-4a8e-be94-69d84b3f7476">
      ...
      <div className="max-w-7xl mx-auto relative w-full">
        <div className="max-w-5xl relative">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-[5.5rem] font-extrabold tracking-tight text-balance leading-[0.95] mb-6 sm:mb-8 text-ink-mid">
            Cabeamento estruturado certificado, do projeto ao laudo
          </h1>
          <p className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-balance leading-[1.05] mb-8 sm:mb-10 text-petrol/70">
            Cabo todo mundo passa. Nós entregamos rede que dura mais que a reforma.
          </p>
      ...
      <div className="max-w-7xl mx-auto">
        <Reveal variant="fade-up" className="mb-12 sm:mb-16 max-w-3xl">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight mb-4 text-balance text-ink-mid">
            Tudo que o seu cabeamento estruturado precisa
          </h2>
        </Reveal>
